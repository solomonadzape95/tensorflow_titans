      ...
      <div className="rounded-xl bg-[#ffffff]/40 mx-auto w-full max-w-md shadow-sm backdrop-blur-2xl">
        ...
        <div className="p-6 pt-0 space-y-4">
          ...
          <div className="text-center">
            <button className="cursor-pointer text-[#4F32FF] font-semibold underline-offset-4 hover:underline h-10 px-4 py-2 text-sm">
              Use demo account
            </button>
          </div>
          ...
          <div className="items-center p-6 pt-3 flex justify-center"><div className="text-sm text-[#6b7280]">Don't have an account? <a className="text-[#4F32FF] hover:underline" href="/">Sign up</a></div></div>
        </div>
      </div>
    </div>
  );
