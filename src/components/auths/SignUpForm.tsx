...
const SignUpForm = () => {
  ...
  const {
    ...
    mutationFn: async () => {
      return await getGroupNameAndCreator(id);
    },
    onError: () => {
  ...
  return (
    <div className="min-h-screen w-screen flex flex-col items-center justify-center bg-[radial-gradient(circle_at_top_right,#4f32ff26,transparent_90%),radial-gradient(circle_at_bottom_left,#f51d7826,transparent_50%)]">
      {isOpen && (
        <Card className="my-4 rounded-xl bg-white/40 mx-auto dark:bg-[#11131E] w-11/12 md:w-full md:max-w-md shadow-lg backdrop-blur-2xl h-[100px]">
          <CardContent className="px-4 pb-2">
            {isPendingDetails ? (
              <div className="text-center text-gray-500">Loading...</div>
            ) : groupDetails ? (
              <div className="text-center space-y-0.5 p-0">
