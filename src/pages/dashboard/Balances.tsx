      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <Card className="gap-3 py-4 bg-[#F9FAFB]/80 dark:bg-[#141727]/90 backdrop-blur-md">
          ...
          <CardContent className="flex items-center justify-between w-full">
            <div className="text-2xl font-bold font-display bg-gradient-to-r from-[#4F32FF] to-[#ff4ecd] text-transparent bg-clip-text">
              $245.89
            </div>
          </CardContent>
        </Card>
      ...
      <Tabs defaultValue="friends" className="space-y-4">
        ...
        <TabsContent value="groups" className="space-y-4 animate-in">
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {["Roommates", "Trip to Paris", "Dinner Club", "Office Lunch"].map(
              (group, i) => (
                <Card
                  key={i}
